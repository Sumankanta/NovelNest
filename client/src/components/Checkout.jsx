  ...
  return (
    <div className="bg-white mt-4 min-h-screen">
      <section className="bg-white py-8 antialiased dark:bg-gray-900 md:py-16">
        <h1 className="mb-10 text-center text-5xl font-bold">Check<span className='text-blue-700'>out</span></h1>
        <form action="#" className="mx-auto max-w-screen-xl px-4 2xl:px-0">
          <ol className="items-center flex w-full max-w-2xl text-center text-sm font-medium  dark:text-black sm:text-base ">
